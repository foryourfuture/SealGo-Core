...
class Lifecycle extends EventEmitter {
  ...
  async start (input: any[]): Promise<SealGo> {
    try {
      // images input
  ...
  private async beforeTransform (ctx: SealGo): Promise<SealGo> {
  ...
  private async doTransform (ctx: SealGo): Promise<SealGo> {
  ...
  private async beforeUpload (ctx: SealGo): Promise<SealGo> {
  ...
  private async doUpload (ctx: SealGo): Promise<SealGo> {
  ...
  private async afterUpload (ctx: SealGo): Promise<SealGo> {
  ...
  private async handlePlugins (plugins: Plugin[], ctx: SealGo): Promise<SealGo> {
